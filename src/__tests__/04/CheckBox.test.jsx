...
describe('<CheckBox>', () => {
    it('renders without crashing', () => {
        expect(() => {
            shallow(<CheckBox name="test_name">테스트</CheckBox>);
        }).not.toThrow();
    });

    it('displays errorMessage', () => {
        const errorMessage = '오류 메시지';
        const errorHtml = shallow(<CheckBox name="test_name" errorMessage={errorMessage}>테스트</CheckBox>)
            .dive()
            .find('span')
            .html();
    ...
    it('calls bock onChange on clicked',  () => {
